...
const CORE=[
  './manifest.webmanifest','./icon.svg','./assets/lotkeys-v09416.js',
...
const RELEASE_SCRIPT='<script id="lotkeys-release-09416" src="./assets/lotkeys-v09416.js?v=09416"></script>';
