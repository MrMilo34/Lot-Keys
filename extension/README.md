...
- [Download the newest Posting Buddy](./releases/LotKeys-Facebook-Assistant-Latest.zip)
- [Download V0.1.13](./releases/LotKeys-Facebook-Assistant-Beta-v0.1.13.zip)
...
4. Replace `LotKeys-Facebook-Assistant-Latest.zip` with the same tested ZIP.
5. Update `latest.json` last so users are never pointed at a partially uploaded release.
