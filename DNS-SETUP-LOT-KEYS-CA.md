...
- Open `https://lot-keys.ca/?build=09474` in a private browser tab after V0.9.4.74 has been promoted to the production `Lot-Keys` repository. Uploading TEST alone does not update this domain.
